...
import 'package:bank_sha/ui/pages/top_up_pulsa_data_page.dart';
import 'package:bank_sha/ui/pages/top_up_success_page.dart';
import 'package:bank_sha/ui/pages/topup_data_page.dart';
    ...
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/topup-success': (contex) => const TopUpSuccessPage(),
          '/transfer': (context) => const TransferPage(),
          '/transfer-amount': (context) => const TransferAmountPage(),
          '/transfer-success': (context) => const TransferSuccessPage(),
          '/topup-data': (context) => const TopUpDataPage(),
          '/topup-pulsa-data': (context) => const TopUpPulsaDataPage(),
          '/topup-data-success': (context) => const TopUpDataSuccessPage(),
        },
      ),
    );
  }
